		...
		return (
			...
			>
				...
				<div className="flex items-center bg-green-400">
					<div className="relative mr-3 bg-red-300 w-7">
						{/* relative inline-flex  */}
						<span className="relative flex items-center justify-center w-6 h-6 ml-12 bg-blue-600 rounded-full">
							<svg
					...
					<div className="flex-1 text-sm font-normal bg-yellow-300 ms-3">
